 ...
 */
package org.gnuhpc.bigdata.systemdesign.consistenthash.sample;

import org.gnuhpc.bigdata.systemdesign.consistenthash.ConsistentHashRouter;
import org.gnuhpc.bigdata.systemdesign.consistenthash.Node;
...
public class MyServiceNode implements Node {
    ...
    public static void main(String[] args) {
        ...
        ConsistentHashRouter<MyServiceNode>
                consistentHashRouter =
                new ConsistentHashRouter<>(Arrays.asList(node1, node2, node3, node4), 10);//10 virtual node
