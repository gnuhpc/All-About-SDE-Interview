...
public class MinDistance72 {
    ...
    public int minDistance1(String word1, String word2) {
        ...
        int replace =
                minDistance1(word1.substring(1), word2.substring(1)) + (word1.charAt(0) == word2.charAt(0) ? 0 : 1);
    ...
    private int getdis(String word1, String word2, Map<String, Integer> memo) {
        ...
        int replace =
                getdis(word1.substring(1), word2.substring(1), memo) + (word1.charAt(0) == word2.charAt(0) ? 0 : 1);
