package org.gnuhpc.interview.concurrency.taskgangframework.framework;
...
/**
 * @class TaskGang
 * @brief 这是一个处理List的通用并行框架, 学习演示所用
 * From LiveLessons and LiveTraining Source Repo
 * Defines a framework for spawning and running a "gang" of
